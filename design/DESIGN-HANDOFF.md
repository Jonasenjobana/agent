# 4f8f0997-c965-4c5d-bf4a-eb2d6d897b92 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `admin/index.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `admin/index.html`
...
- A single self-contained `admin/index.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `admin/index.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `admin/projects.html`
- `admin/token-logs.html`
- `admin/users.html`
- `enterprise-kb-chat.html`
- `index.html`
- `knowledge-base.html`
- `login.html`
- `settings.html`
...
1. Inspect `admin/index.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
